...
var styleSwitcher = {
	...
	setColor: function(a) {
		...
		return this.isChanging ? !1 : (b.options.color = a, less.modifyVars({
			...
			skinColor: a
		}), $.cookie("skin", a), void this.setLogo())
	},
