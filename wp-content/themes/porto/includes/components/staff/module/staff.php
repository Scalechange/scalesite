    ...
    function generate_item( $post_ID, $atts ) {
        ...
        if( isset( $info['socials'] ) && !empty( $info['socials'] ) ) {
            ...
            foreach( $info['socials'] as $item ) {
                ...
                $socials .= '<a rel="tooltip" data-placement="bottom" target="_blank" href="' . $mailto . $url . '" data-original-title="' . $social_title . '"><i class="icon icon-' . $item['network'] . '"></i><span>' . $social_title . '</span></a> ';
            }
