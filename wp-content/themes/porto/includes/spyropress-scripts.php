...
function spyropress_register_stylesheets() {
    ...
    // Libs CSS
    wp_enqueue_style( 'bootstrap', assets() . 'vendor/bootstrap/css/bootstrap.css' );
    wp_enqueue_style( 'font-awesome', assets() . 'vendor/font-awesome/css/font-awesome.css' );
...
function spyropress_register_scripts() {
    ...
    // Plugins
    wp_register_script( 'jquery-plugins', assets() . 'js/theme.plugins.js', false, false, true );
    ...
    wp_register_script( 'bootstrap', assets() . 'vendor/bootstrap/js/bootstrap.js', false, false, true );
