    ...
    if( isset( $container_skin ) && !empty( $container_skin ) ) {
        ...
        if( 'video_section' == $container_skin ) {
            ...
            if( $video_mp4 || $video_ogg )
                $video = '<div class="video-overlay"></div><video autoplay loop poster="' . $video_poster . '" data-plugin-options=\'{ "videoWidth": "100%", "videoHeight": "100%", "enableAutosize": "true" }\'>' . $mp4 . $ogg . '</video>';
        }
    }
