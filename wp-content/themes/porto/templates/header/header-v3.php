	...
	<div class="container">
        ...
        <h1 class="logo">
			<a href="<?php echo esc_url( home_url( '/' ) ) ?>">
				<img alt="<?php bloginfo( 'name' ) ?>" width="<?php get_setting_e( 'logo_width', 111 ) ?>" height="<?php get_setting_e( 'logo_height', 54 ) ?>" data-sticky-width="82" data-sticky-height="40" src="<?php echo $logo ?>">
			</a>
		</h1>
        <?php endif; ?>
