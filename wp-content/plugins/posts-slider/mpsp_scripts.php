...
// Adding Scripts and styles required by posts slider plugin
...
function mpsp_scripts_add() {
    ...
    wp_enqueue_script( 'my-script-handle', plugins_url('/lpp_color_picker.js', __FILE__ ), array( 'wp-color-picker' ), false, true );
}
