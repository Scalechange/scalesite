...
function caa_get_author_details_from_wordpress_user_profile(){
	$wordpres_author_details = array( 	
		...
		CAA_Author::skype => get_the_author_meta(CAA_Author::skype),
		CAA_Author::xing => get_the_author_meta(CAA_Author::xing),
		CAA_Author::custom_icon_1 => get_the_author_meta(CAA_Author::custom_icon_1),
		CAA_Author::custom_link_1 => get_the_author_meta(CAA_Author::custom_link_1),
		CAA_Author::custom_icon_2 => get_the_author_meta(CAA_Author::custom_icon_2),
		CAA_Author::custom_link_2 => get_the_author_meta(CAA_Author::custom_link_2),
		CAA_Author::custom_icon_3 => get_the_author_meta(CAA_Author::custom_icon_3),
		CAA_Author::custom_link_3 => get_the_author_meta(CAA_Author::custom_link_3),
...
function caa_get_author_details_from_database($username, $convert_line_feeds_to_br = false){
	...
	if($result){
		...
		$database_author_details = array(
			...
			CAA_Author::skype => $result->skype,
			CAA_Author::xing => $result->xing,
			CAA_Author::custom_icon_1 => $result->custom_icon_1,
			CAA_Author::custom_link_1 => $result->custom_link_1,
			CAA_Author::custom_icon_2 => $result->custom_icon_2,
			CAA_Author::custom_link_2 => $result->custom_link_2,
			CAA_Author::custom_icon_3 => $result->custom_icon_3,
			CAA_Author::custom_link_3 => $result->custom_link_3,
...
function caa_get_all_social_media($author){
	...
	caa_add_social_media($author, CAA_Author::skype).
	caa_add_social_media($author, CAA_Author::xing).
	caa_add_social_media($author, CAA_Author::custom_link_1).
	caa_add_social_media($author, CAA_Author::custom_link_2).
	caa_add_social_media($author, CAA_Author::custom_link_3);
	if($content!=""){
		$content = "<p>".$content."</p>";
	}
	return $content;
...
function caa_add_social_media($author, $media_type){
	...
	if($media_type == CAA_Author::twitter){
		$social_media_content .= '<a href="'.CAA_Config::twitter_url_prefix.$social_media_id.'" rel="Twitter me" id="cab-twitter">' .
		...
		$social_media_content .= '<a href="'.CAA_Config::facebook_url_prefix. $social_media_id.'" rel="Facebook me" id="cab-facebook">' .
		...
		$social_media_content .= '<a href="'.CAA_Config::google_plus_url_prefix.$social_media_id.'" rel="me publisher author" id="cab-google_plus">' .
		...
		$social_media_content .= '<a href="'.CAA_Config::linkedin_url_prefix.$social_media_id.'" rel="LinkedIn me" id="cab-linkedin">' .
		...
		$social_media_content .= '<a href="'.CAA_Config::flickr_url_prefix.$social_media_id.'" rel="Flickr me" id="cab-flickr">' .
		...
		$social_media_content .= '<a href="'.CAA_Config::youtube_url_prefix.$social_media_id.'" rel="YouTube me" id="cab-youtube">' .
		...
		$social_media_content .= '<a href="'.CAA_Config::vimeo_url_prefix.$social_media_id.'" rel="Vimeo me" id="cab-vimeo">' .
									'<img title="Vimeo" src="' . $caa_plugin_dir_path . '/images/social_media/vimeo.png" alt="Vimeo" border="0" /></a>&nbsp;';
	}else if($media_type == CAA_Author::skype){
		$social_media_content .= '<a href="'.CAA_Config::skype_url_prefix.$social_media_id.'?userinfo" rel="Skype me" id="cab-skype">' .
									'<img title="Skype" src="' . $caa_plugin_dir_path . '/images/social_media/skype.png" alt="Skype" border="0" /></a>&nbsp;';
	}else if($media_type == CAA_Author::xing){
		$social_media_content .= '<a href="'.CAA_Config::xing_url_prefix.$social_media_id.'" rel=" Xing me" id="cab-xing">' .
									'<img title="Xing" src="' . $caa_plugin_dir_path . '/images/social_media/xing.png" alt="Xing" border="0" /></a>&nbsp;';
	}else if($media_type == CAA_Author::custom_link_1){
		$custom_icon_1 = $author[CAA_Author::custom_icon_1];
		$social_media_content .= '<a href="'.$social_media_id.'" rel="me" id="cab-custom-1">' .
									'<img src="' . $custom_icon_1 . '" height=32px border="0" /></a>&nbsp;';
	}else if($media_type == CAA_Author::custom_link_2){
		$custom_icon_2 = $author[CAA_Author::custom_icon_2];
		$social_media_content .= '<a href="'.$social_media_id.'" rel="me" id="cab-custom-2">' .
									'<img src="' . $custom_icon_2 . '" height=32px border="0" /></a>&nbsp;';
	}else if($media_type == CAA_Author::custom_link_3){
		$custom_icon_3 = $author[CAA_Author::custom_icon_3];
		$social_media_content .= '<a href="'.$social_media_id.'" rel="me" id="cab-custom-3">' .
									'<img src="' . $custom_icon_3 . '" height=32px border="0" /></a>&nbsp;';
	}
